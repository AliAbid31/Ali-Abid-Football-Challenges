...
const TrophiesChallenge = () => {
  ...
  // Chaque objet représente un input dans le jeu
  // 'property' est la clé dans l'objet club pour obtenir le nombre de trophées
  // 'mult' est le multiplicateur appliqué à cette propriété
  // 'placeholder' est le texte affiché sur l'input
  ...
  const startRotation = useCallback(() => {
    ...
    rotationIntervalRef.current = setInterval(() => {
      ...
      if (newClubData && typeof newClubData.name2 === 'string' && typeof newClubData.name === 'string') {
        // Supposons que les images des clubs sont nommées comme "NomClub_60x60.png" dans un dossier /club_icons/
