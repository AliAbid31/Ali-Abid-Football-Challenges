...
const AssistsChallenge = () => {
  ...
  useEffect(() => {
    ...
    // Initialiser textInputsRef.current avec les éléments réels une fois le DOM monté
    // (si les refs sont passées directement aux inputs, elles sont déjà là)
    // S'assurer que les refs sont bien initialisées avant le premier appel à startRotation.
    // On peut le faire en s'assurant que le map des inputs a bien rendu les refs.
    // Le startRotation initial est OK ici.
    fetchAndDisplayAssistsPageLeaderboard();
    startRotation();
