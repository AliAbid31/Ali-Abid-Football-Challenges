...
function Home() {
  ...
  // --- useEffect pour charger les leaderboards ---
  useEffect(() => {
    // ... (logique existante, semble correcte)
  ...
  if (!isLoggedIn) {
    ...
    return (
      // La classe .sectionlogin est le conteneur principal pour la vue non connectée
      <section className='sectionlogin'>
        {/* Vue "Welcome" avec les boutons Login et Register */}
        {authMode === 'welcome' && (
        ...
        {/* Vue "Login" ou "Register" avec le formulaire */}
        {(authMode === 'login' || authMode === 'register') && (
          <div className='auth-form'> {/* Appliquera les styles et animations de .auth-form */}
            <p className='form-title'>{authMode === 'login' ? 'Login' : 'Register'}</p> {/* Sera stylé par .form-title */}
            {error && (<div className='error-message'>{error}</div>)} {/* Styles pour les messages d'erreur */}
            <form onSubmit={authMode === 'login' ? handleLogin : handleRegister}>
              ...
              <input
                ...
                required
              />
              <div className="form-actions"> {/* Styles pour le conteneur des actions du formulaire */}
                <button type="button" onClick={handleBack} className="back-btn">
                  <FaArrowLeft /> Back
                </button>
                <button type="submit" className={authMode === 'login' ? 'submit-btn-login' : 'submit-btn-register'}>
